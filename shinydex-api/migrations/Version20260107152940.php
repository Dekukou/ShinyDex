 ...
 */
final class Version20260107152940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ability (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_35CFEE3C5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attack (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, name VARCHAR(150) NOT NULL, INDEX IDX_47C02D3BC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE egg_group (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_32F802765E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, generation_id INT NOT NULL, name VARCHAR(150) NOT NULL, INDEX IDX_232B318C553A6EC4 (generation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_1F1B251E5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE machine (id INT AUTO_INCREMENT NOT NULL, generation_id INT NOT NULL, code VARCHAR(50) NOT NULL, INDEX IDX_1505DF84553A6EC4 (generation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, species_id INT NOT NULL, generation_id INT NOT NULL, family_id INT DEFAULT NULL, dex_number INT NOT NULL, name VARCHAR(150) NOT NULL, INDEX IDX_62DC90F3B2A1D860 (species_id), INDEX IDX_62DC90F3553A6EC4 (generation_id), INDEX IDX_62DC90F3C35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_attack_level (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT NOT NULL, attack_id INT NOT NULL, level INT NOT NULL, INDEX IDX_52132CE2FE71C3E (pokemon_id), INDEX IDX_52132CEF5315759 (attack_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pokemon_attack_machine (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT NOT NULL, attack_id INT NOT NULL, machine_id INT NOT NULL, INDEX IDX_7B9624062FE71C3E (pokemon_id), INDEX IDX_7B962406F5315759 (attack_id), INDEX IDX_7B962406F6B75B26 (machine_id), UNIQUE INDEX uniq_pokemon_machine_attack (pokemon_id, machine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_egg_group (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT NOT NULL, egg_group_id INT NOT NULL, INDEX IDX_311E8502FE71C3E (pokemon_id), INDEX IDX_311E850B76DC94C (egg_group_id), UNIQUE INDEX uniq_pokemon_egg_group (pokemon_id, egg_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_family (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_sprite (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT NOT NULL, front_default VARCHAR(255) NOT NULL, front_female VARCHAR(255) DEFAULT NULL, front_shiny VARCHAR(255) NOT NULL, front_shiny_female VARCHAR(255) DEFAULT NULL, form_key VARCHAR(50) DEFAULT NULL, source VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_59F4F3CA2FE71C3E (pokemon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE region_form (id INT AUTO_INCREMENT NOT NULL, species_id INT NOT NULL, name VARCHAR(100) NOT NULL, INDEX IDX_8B2EEA78B2A1D860 (species_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_8CDE57295E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pokemon_attack_machine ADD CONSTRAINT FK_7B962406F5315759 FOREIGN KEY (attack_id) REFERENCES attack (id)');
        ...
        $this->addSql('ALTER TABLE pokemon_egg_group ADD CONSTRAINT FK_311E8502FE71C3E FOREIGN KEY (pokemon_id) REFERENCES pokemon (id)');
        ...
        $this->addSql('ALTER TABLE region_form ADD CONSTRAINT FK_8B2EEA78B2A1D860 FOREIGN KEY (species_id) REFERENCES pokemon_species (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon_attack_machine DROP FOREIGN KEY FK_7B962406F5315759');
        ...
        $this->addSql('ALTER TABLE region_form DROP FOREIGN KEY FK_8B2EEA78B2A1D860');
