 ...
 */
final class Version20260109192059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, species_id INT NOT NULL, family_id INT DEFAULT NULL, generation_id INT DEFAULT NULL, region_form_id INT DEFAULT NULL, form_key VARCHAR(150) NOT NULL, name_fr VARCHAR(150) DEFAULT NULL, name_en VARCHAR(150) DEFAULT NULL, is_default TINYINT(1) NOT NULL, is_mega TINYINT(1) NOT NULL, is_gmax TINYINT(1) NOT NULL, hp INT DEFAULT NULL, attack INT DEFAULT NULL, defense INT DEFAULT NULL, special_attack INT DEFAULT NULL, special_defense INT DEFAULT NULL, speed INT DEFAULT NULL, UNIQUE INDEX UNIQ_62DC90F3CFAF3820 (form_key), INDEX IDX_62DC90F3B2A1D860 (species_id), INDEX IDX_62DC90F3C35E566A (family_id), INDEX IDX_62DC90F3553A6EC4 (generation_id), INDEX IDX_62DC90F344E4EAFA (region_form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
