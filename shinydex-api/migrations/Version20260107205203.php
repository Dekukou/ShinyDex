 ...
 */
final class Version20260107205203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ability (id INT AUTO_INCREMENT NOT NULL, api_identifier VARCHAR(150) NOT NULL, name_fr VARCHAR(150) NOT NULL, name_en VARCHAR(150) NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_35CFEE3CB084FF7B (api_identifier), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE machine (id INT AUTO_INCREMENT NOT NULL, generation_id INT NOT NULL, attack_id INT NOT NULL, name VARCHAR(50) NOT NULL, INDEX IDX_1505DF84553A6EC4 (generation_id), INDEX IDX_1505DF84F5315759 (attack_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, species_id INT NOT NULL, family_id INT DEFAULT NULL, generation_id INT DEFAULT NULL, region_form_id INT DEFAULT NULL, name_en VARCHAR(150) NOT NULL, name_fr VARCHAR(150) DEFAULT NULL, hp INT DEFAULT NULL, attack INT DEFAULT NULL, defense INT DEFAULT NULL, special_attack INT DEFAULT NULL, special_defense INT DEFAULT NULL, speed INT DEFAULT NULL, UNIQUE INDEX UNIQ_62DC90F33D773AC4 (name_en), INDEX IDX_62DC90F3B2A1D860 (species_id), INDEX IDX_62DC90F3C35E566A (family_id), INDEX IDX_62DC90F3553A6EC4 (generation_id), INDEX IDX_62DC90F344E4EAFA (region_form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_attack_level (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT NOT NULL, attack_id INT DEFAULT NULL, level INT NOT NULL, INDEX IDX_52132CE2FE71C3E (pokemon_id), INDEX IDX_52132CEF5315759 (attack_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pokemon_attack_machine (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT NOT NULL, attack_id INT DEFAULT NULL, machine_id INT NOT NULL, INDEX IDX_7B9624062FE71C3E (pokemon_id), INDEX IDX_7B962406F5315759 (attack_id), INDEX IDX_7B962406F6B75B26 (machine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
